                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <?php if (isset($_SESSION['udanarejestracja'])) {
                                            echo "Udało ci się zarejestrować konto! Teraz zaloguj się!";
                                    ...
                                    <form action="login_z.php" method="POST">
                                        ...
                                        <a href="index.php" class="btn btn-google btn-user btn-block">
                                            <i class="fab fa-google fa-fw"></i> Zaloguj za pomocą konta Google
                                        </a>
                                        <a href="index.php" class="btn btn-facebook btn-user btn-block">
                                            <i class="fab fa-facebook-f fa-fw"></i> Zaloguj za pomocą konta Facebook
                                        </a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="forgot-password.php">Zapomniałem hasło</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="register.php">Stwórz konto</a>
                                    </div>
